...
// Wrappers for various functions:
    ...
    inline unsigned long wxStrtoul_lA(const char *c, char **endptr, int base, const wxXLocale& loc)
        { return 0; } //wxCRT_Strtoul_lA(c, endptr, base, loc.Get()); }
